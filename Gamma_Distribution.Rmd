...
set.seed(3)
x1 <- rgamma(100000, shape = 1, rate= 1/30)
x2 <- rgamma(100000, shape = 2, rate= 1/30)
x3 <- rgamma(100000, shape = 3, rate= 1/30)
x4 <- rgamma(100000, shape = 4, rate= 1/30)
...
#hist(x,prob=T)
#lines( sort(x) , y = dgamma( sort(x) , shape = 2 , rate = 1/30) , col = "blue" , lty = 2 , lwd = 2 )
